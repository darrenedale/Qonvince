...
namespace Qonvince
{
    ...
    public:
        ...
        [[nodiscard]] inline bool singleInstance() const
        {
            return m_singleInstance;
        }

        [[nodiscard]] inline bool quitOnMainWindowClosed() const
        {
            return m_quitOnMainWindowClosed;
        }

        [[nodiscard]] inline bool startMinimised() const
        {
            return m_startMinimised;
        }

        [[nodiscard]] inline bool copyCodeOnClick() const
        {
        ...
        [[nodiscard]] inline bool hideOnCodeCopyClick() const
        {
        ...
        [[nodiscard]] inline bool clearClipboardAfterInterval() const
        {
        ...
        // clipboard
        [[nodiscard]] inline int clipboardClearInterval() const
        {
            return m_clipboardClearInterval;
        }

        [[nodiscard]] inline CodeLabelDisplayStyle codeLabelDisplayStyle() const
        {
            return m_codeLabelDisplayStyle;
        }

        [[nodiscard]] inline int codeRevealTimeout() const
        {
