...
namespace Qonvince
{
	 ...
	 * (That is, byte 1 represents the top left element, byte 2 the element
	 ...
	 * is set, the element is a 1 and should be rendered in the foreground
	...
	public:
		...
		LibQrEncode() noexcept;

		[[nodiscard]] QrCode encodeString(const QString & data) const;
